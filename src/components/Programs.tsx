  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        {isLast ? (
          <a
            href="https://youtube.com/live/y5zAOr1Rr40?feature=share"
            target="_blank"
            rel="noopener noreferrer"
            className="group/btn inline-flex items-center space-x-2 text-blue-600 dark:text-blue-400 font-semibold hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
          >
